    ...
    return (
        <div id="compania" className="container-fluid fh5co-about-us pl-0 pr-0 parallax-window" data-parallax="scroll" data-image-src={ about_us_bg }>
            <div className="container">
                ...
                <hr/>
                <p data-wow-delay=".25s"><b>MAIKA TEATRO</b> &nbsp;
                ...
                <a className="btn btn-sm btn-outline-danger d-inline-block text-center mx-auto" style={{backgroundColor:'black'}} href="/pages/compania">Mas detalles</a> </div>
            </div>
        </div>
    )
}
